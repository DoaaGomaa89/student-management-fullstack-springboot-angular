...
public class DbConfiguration {
    ...
    CommandLineRunner commandLineRunner(StudentRepository studentRepository,
        ...
        return args -> {
            ...
            // ---- RUN ONLY IF DATABASE IS EMPTY (any table has data -> skip) ----
            if (facultyRepository.count() > 0
                    || classroomRepository.count() > 0
                    || studentRepository.count() > 0
                    || courseRepository.count() > 0
                    || resultRepository.count() > 0
                    || libraryCardRepository.count() > 0) {
                log.info("Seed skipped: tables already contain data.");
                return;
            }
            ...
            Student minh = new Student(
                    ...
                    "minh@gmail.com",
                    Gender.Male,
                    LocalDate.of(1999, Month.NOVEMBER, 5),
                    classDCT2);
            ...
            log.info("Initial seed inserted.");
        };
    }
}
